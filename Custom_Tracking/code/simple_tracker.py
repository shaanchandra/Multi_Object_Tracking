...
from trackers import CV2_TRACKER, Siam_TRACKER
    ...
    if args.input_type == 0:
        ...
        for image in image_files:
            ...
            if initBB is not None:
                if args.model == 0:
                    initBB, fps, succcess_count, fail_count, df = CV2_TRACKER(args, frame, tracker, initBB, fps, succcess_count, fail_count, df)
                else:
                    frame, tracker, initBB, state, fps, df = Siam_TRACKER(args, frame, tracker, initBB, state, fps, df)
