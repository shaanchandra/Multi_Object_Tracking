...
def video_TRACKER(tracker, path):
    print("="*80 + "\n\t\t\t\t TRACKING\n" + "="*80)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--vid_path", type=str, help="path to input video file", default = "./data/fish_video.mp4")
    ...
    if args.input_type== 0:
        img_TRACKER(tracker, path)
    elif args.input_type == 1:
        video_TRACKER(tracker, path)
    else:
